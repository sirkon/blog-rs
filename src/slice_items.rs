...
impl JSONLiteral for bool {
    #[inline(always)]
    unsafe fn render(_r: &mut LogRender, dst: &mut Vec<u8>, src: *const u8) -> *const u8 { unsafe {
        if *src != 0 {
...
impl JSONLiteral for i8 {
    #[inline(always)]
    unsafe fn render(r: &mut LogRender, dst: &mut Vec<u8>, src: *const u8) -> *const u8 { unsafe {
